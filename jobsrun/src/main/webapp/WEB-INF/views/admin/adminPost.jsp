...
<link rel="stylesheet" href="<c:url value='/resources/css/admin/posttable.css'/>">
<link rel="stylesheet"
...
<body>
	...
	<h3>의뢰자게시물 관리</h3>
	<div>
		<button class="button button2"><a style = "width:100%; height:100%;" href="<c:url value='/admin/adminmember'/>">회원관리</a></button>
			<button class="button button3"><a style = "width:100%; height:100%;" href="<c:url value='/admin/adminpost/1'/>">의뢰자게시물</a></button>
			<button class="button button5"><a style = "width:100%; height:100%;" href="<c:url value='/admin/adminpost2/2'/>">해결사게시물</a></button>
