...
<body>
  <div class="container">
    ...
    <form:form action="${pageContext.request.contextPath }/board/write/${returnPage }"
     ...
     <div class="writeFormTitle">해결사 글쓰기</div>
     </c:if>
      <div class="btitle">
      ...
      <div class="bcontent">
        <form:label path="bcontent">업무 상세 내용</form:label>
       ...
       <div class="category">
  		...
  		<div class="categoryItems">
	        ...
	        <div>
		        <div id = "blocationdiv">
		        <span style="position:relative; left:3px;"><span style = "color:red;">*</span>6.위치</span> 
		        <form:input type ="text"  readonly = "true" cssClass = "blocation" path ="blocation" style = " font-size:14px;"/>
		         <button id = "search2" type ="button">검색</button></div>		 		        
...
function placesSearchCB(data, status, pagination) {
    if (status === kakao.maps.services.Status.OK) {
		...
		console.log("data" + JSON.stringify(data[0].address_name));
		...
		var address_name = JSON.stringify(data[0].address_name);
		console.log("place_name = " + place_name);
		blocation.value = address_name.replace(/\"/g, "") + place_name.replace(/\"/g, "");
