...
<title>Insert title here</title>
	<link rel="stylesheet" href="<c:url value='/resources/css/clause/base.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/css/clause/button.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/css/clause/join.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/css/clause/pdsr.css'/>">
    <link rel="stylesheet" href='https://cdn.rawgit.com/openhiun/hangul/14c0f6faa2941116bb53001d6a7dcd5e82300c3f/nanumbarungothic.css'  type='text/css'>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">   
  	<link rel="stylesheet" href="<c:url value='/resources/css/member/joinFormclause.css'/>">
  	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Sunflower:300&display=swap" >
  	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nanum+Gothic&display=swap" >
  	<script src="<c:url value ='/resources/js/member/joinFormclause.js'/>"></script>
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                <input type="checkbox" name = "check1" id = "check1">이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" name = "check2" id = "check2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
			<!-- 이용약관 테이블 끝 -->
...
<!-- 제일 큰 테이블 끝 -->
<br><br>
  <button type = "button" id="joinBtn1" class="btn_order" style="margin:10px;">회 원 가 입</button>
